 ...
 */
function CubicBezier(p1, p2, p3, p4, n, color, showTemp) {
    this.color = color || "#000";
    this.n = n || 30;
    this.p1 = p1 || {x: 100, y: 100};
    this.p2 = p2 || {x: 200, y: 200};
    this.p3 = p3 || {x: 100, y: 200};
    this.p4 = p4 || {x: 300, y: 300};
    this.showTemp = showTemp || false;
...
CubicBezier.prototype.draw = function (context) {
    ...
    for(var i=0; i<=this.n; i++){
        ...
        if (this.showTemp) {
          context.moveTo(next_point1.x, next_point1.y);
          context.lineTo(next_point2.x, next_point2.y);
        }
